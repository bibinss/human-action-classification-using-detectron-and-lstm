...
def draw_keypoints(person, img):
  ...
  drawLine(img, (l_shoulder[0], l_shoulder[1]), (l_elbow[0], l_elbow[1]), (0, 255, 0))
  drawLine(img, (l_elbow[0], l_elbow[1]), (l_wrist[0], l_wrist[1]), (0, 255, 0))
  drawLine(img, (l_shoulder[0], l_shoulder[1]), (r_shoulder[0], r_shoulder[1]), (0, 255, 0))
  drawLine(img, (l_shoulder[0], l_shoulder[1]), (l_hip[0], l_hip[1]), (0, 255, 0))
  drawLine(img, (r_shoulder[0], r_shoulder[1]), (r_hip[0], r_hip[1]), (0, 255, 0))
  drawLine(img, (r_shoulder[0], r_shoulder[1]), (r_elbow[0], r_elbow[1]), (0, 255, 0))
  drawLine(img, (r_elbow[0], r_elbow[1]), (r_wrist[0], r_wrist[1]), (0, 255, 0))
  drawLine(img, (l_hip[0], l_hip[1]), (r_hip[0], r_hip[1]), (0, 255, 0))
  drawLine(img, (l_hip[0], l_hip[1]), (l_knee[0], l_knee[1]), (0, 255, 0))
  drawLine(img, (l_knee[0], l_knee[1]), (l_ankle[0], l_ankle[1]), (0, 255, 0))
  drawLine(img, (r_hip[0], r_hip[1]), (r_knee[0], r_knee[1]), (0, 255, 0))
  drawLine(img, (r_knee[0], r_knee[1]), (r_ankle[0], r_ankle[1]), (0, 255, 0))
